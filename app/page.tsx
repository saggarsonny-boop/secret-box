    ...
    <main style={{background:'#0a0a0a',minHeight:'100vh',color:'#e8e8e8',fontFamily:'Georgia,serif',maxWidth:'600px',margin:'0 auto',padding:'24px 16px'}}>
      ...
      {view === 'feed' && (
        <div>
          ...
          <div style={{textAlign:'center',marginTop:'48px',paddingTop:'32px',borderTop:'1px solid #111'}}><p style={{fontSize:'12px',color:'#333',marginBottom:'12px',lineHeight:'1.8'}}>this app is free, forever.<br/><span style={{color:'#2a2a2a'}}>if it helped you, you can support it.</span></p><button onClick={()=>window.open('https://buy.stripe.com/14A6oJ6Mv3sReEa0YV0RG00','_blank')} style={{background:'transparent',border:'1px solid #2a2a2a',color:'#444',padding:'8px 24px',fontSize:'11px',letterSpacing:'2px',cursor:'pointer'}}>SUPPORT THIS</button></div>
        </div>
      )}
